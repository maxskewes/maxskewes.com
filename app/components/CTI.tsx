      ...
      <div className='mt-10 mb-20'>
        ...
        <div className='p-6 rounded overflow-hidden bg-zinc-100 shadow-md flex-col'>
          <div>
            ...
            A Hack for LA project, the CTI is a web application to connect willing volunteers with projects relavant to civic issues, world-wide. Through use of its &ldquo;Tag Generator Wizard&rdquo;, projects are tagged with appropriatly related topics, enabling them to be cataloged and easily accessed by developers and project leaders globally.
            </p>
          </div>
            ...
            >
              ...
              <div className='flex justify-center items-center text-center'>
                <p className='underline-offset-4 text-base text-zinc-800'>
                  Visit the currently dormant website for the Civic Tech Index. <br/>
                  <i>production presently on hold</i>
                </p>
              </div>
            </a>
          </div>
