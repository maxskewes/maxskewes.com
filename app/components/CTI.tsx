  ...
  return (
    <>
      <div className='mb-4 flex flex-col justify-center items-center'>
        ...
        <p className='text-justify font-light mx-4 md:mx-20 indent-4 md:indent-8'>
          I initially volunteered with Hack for LA&apos;s Civic Tech Index
          project during a day-log &ldquo;hack-a-thon&rdquo; in which I helped
          with some simple front-end responsiveness. I instantly realized the
          potential for enormous benefit that, when completed, this application
          could provide. I signed on as a regular volunteer and, over the next
          year and a half, was one of several developers who gave around ten
          hours a week of their time. I was later promoted to Lead Front-End
          Developer, which required a more organizational role as well more
          regular meetings with project managers. Unfortunately, due to an
          undisclosed higher-level organizational concern, the project was
          haulted weeks before a projected Alpha-Release and has yet to be
          revisited. Following the link below will give access to the majority
          of what was created and hopefully a decent indication of what this
          project, when completed, could accomplish.
        </p>
      </div>
      ...
      <div className='p-6 rounded overflow-hidden bg-zinc-100 shadow-md flex-col'>
        <div>
          ...
          <p className='font-normal text-zinc-600 text-justify sm:text-center indent-4 md:indent-0'>
