      ...
      <div className='mt-10 mb-20'>
        <div className='mb-4 flex flex-col justify-center items-center'>
          ...
          <p className='font-light mx-20'>
            ...
            Unfortunately, due to an undisclosed higher-level organizational concern, the project
            was haulted weeks before a projected Alpha-Release and has yet to be revisited.
            Following the link below will give access to the majority of what was created and
            hopefully a decent indication of what this project, when completed, could accomplish.
          </p>
        </div>
        ...
        <div className='p-6 rounded overflow-hidden bg-zinc-100 shadow-md flex-col'>
          <div>
            ...
            <p className='font-normal text-zinc-600 text-center'>
              ...
              Wizard&rdquo;, projects are tagged with appropriatly related topics, enabling them to
              be cataloged and easily accessed by developers and project leaders globally.
            </p>
          </div>
