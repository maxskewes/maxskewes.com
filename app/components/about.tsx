      ...
      <SectionWrapper title={title}>
        <div className='pb-4 text-zinc-800'>
          ...
          <p className='indent-8'>
            ...
            contributing to the development and design and of interactive websites and custom
            applications, I am fluent in Typescript, ReactJS, API calls, and several Javascript
            languages, frameworks, and libraries. Though I have spent substantial time personally
            contracted to build apps and websites for a wide variety of products and causes, I truly
            love working on a team. I’m known for my communication skills and enjoy collaborating
            with all members, from frontend to backend to UX/UI designers to management to client.
            Working smart and being diligent, but never afraid to reach out for extra eyes and
            input, is what leads to efficiency in the development environment.
          </p>
        </div>
        ...
        <div className='ml-2'>
          <div className='flex flex-row items-center'>
            ...
            <div className='p-1 pt-2 pl-4 my-3 bg-violet-50 shadow-md rounded text-zinc-800'>
              <p className='pb-2 ml-4'>
                <b className='text-bluesteel'>Served as lead front-end developer </b>during the
                creation of a React application projected to serve over{' '}
                <b className='text-bluesteel'>100,000 users worldwide</b>, utilizing ReactJS with
                MUI framework to realize a Figma design.
              </p>
            </div>
          </div>
          ...
          <div className='flex flex-row items-center'>
            ...
            <div className='p-1 pt-2 pl-4 my-3 bg-violet-50 shadow-md rounded text-zinc-800'>
              <p className='pb-2 ml-4'>
                <b className='text-bluesteel'>Created intuitive websites </b>for companies across
