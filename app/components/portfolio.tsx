    ...
    <section>
      ...
      <div className='grid lg:grid-cols-2 gap-4 auto-rows-max'>
        ...
        {data.map(
          ...
          <div key={cardTitle} className='p-6 rounded overflow-hidden bg-grey-light drop-shadow-md'>
            <h4>{cardTitle}</h4>
        ...
        <div className='p-6 rounded overflow-hidden bg-grey-light drop-shadow-md'>
          ...
          <div className='h-full'>
            <div className='flex-col grow-1 justify-between'>
              <p className='mt-2'>
                A website built with Reactjs. Designed and created all
        ...
        <div className='p-6 rounded overflow-hidden bg-grey-light drop-shadow-md'>
          ...
          <div className='h-full'>
            <div className='flex-col grow-1 justify-between'>
              <p className='mt-2'>
                A Hack for LA project, the CTI is web application to catalog
                every open source civic tech project and enable developers to
                connect willing volunteers with their dream projects to help
                with civic issues.
              </p>
