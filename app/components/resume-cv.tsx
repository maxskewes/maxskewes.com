      ...
      <div className='bg-white mt-2 pt-2 p-6 drop-shadow-md'>
        ...
        <div className='mb-10'>
          ...
          <p className='font-serif'>
            ...
            Proficient in ReactJS, Typescript, Node.js, JavaScript, HTML, CSS,
            WordPress, Material-UI, Chakra-UI, Next.js, Bootstrap, Formik, Git,
            GitHub, Bitbucket, Jira, SQL, Slack, and social media platforms.
          </p>
        </div>
        ...
        <div className='mb-10'>
          ...
          <div className='mb-8'>
            ...
            <p className='font-light '>
              Completed intensive coursework in HTML, CSS, JavaScript, React,
              MySQL, and Node.js.
            </p>
          </div>
          ...
          <div className='mb-2'>
            ...
            <i className='font-light'>
              with minor focus on Irish Language &#40;Gaeilge&#41;.
            </i>
          </div>
        </div>
            ...
            <div className='font-light'>
              <ul className='list-disc pl-4'>
                ...
                <li>
                  ...
                  promoting full adherence to Figma design specifications across
                  multiple display sizes.
                </li>
                <li>
                  Developed custom and reusable components, utilizing Chakra UI,
                  formik, and create-react-app, while adhering to UX/UI
            ...
            <div className='font-light'>
              <ul className='list-disc pl-4'>
                <li>
                  ...
                  showcasing work of over 250 talented artists to date, earning
                  favorable reviews in regional media outlets such as Willamette
                ...
                <li>
                  ...
                  features, successfully raising over $15,000 for Portland-based
                  women&apos;s shelter and achieving 80% increase in festival
                  revenue.
                </li>
                <li>
            ...
            <div className='font-light'>
              <ul className='list-disc pl-4'>
                <li>
                  ...
                  sectors including legal services, real estate, entertainment,
                  and food and beverage sectors, implementing e-commerce
                  capabilities for products sold across North America.
                </li>
                <li>
                  Contracted for building of business websites using ReactJS and
                  frameworks including Material UI, Chakra-UI, and Next.js.
                </li>
              </ul>
            </div>
          </div>
